...
sudo umount /mnt
sudo chown -R $USER:$USER fr_windows_7_professional_with_sp1_x86_dvd_u_677092/
sudo chown -R $USER:$USER fr_windows_7_professional_with_sp1_x86_dvd_u_677092/*
sudo chown -R 777 fr_windows_7_professional_with_sp1_x86_dvd_u_677092/
sudo chown -R 777 fr_windows_7_professional_with_sp1_x86_dvd_u_677092/*
export WINEARCH=win32 WINEPREFIX=$HOME/.dism
sudo rm -rf $HOME/.dism
#sudo wiminfo fr_windows_7_professional_with_sp1_x86_dvd_u_677092/sources/install.wim
sudo rm -f adksetup.exe
sudo rm -f adkoffline.part1.exe
sudo rm -f adkoffline.part2.rar
sudo rm -f adkoffline.part3.rar
sudo rm -f adkoffline.part4.rar
sudo rm -f adkoffline.part5.rar
...
sudo WINEARCH=win32 WINEPREFIX=$HOME/.dism winetricks --self-update
...
WINEARCH=win32 WINEPREFIX=$HOME/.dism wine "C:\Program Files\Windows Kits\10\Assessment and Deployment Kit\Deployment Tools\x86\DISM\dism.exe" /Get-ImageInfo /imagefile:"Z:\home\$USER\fr_windows_7_professional_with_sp1_x86_dvd_u_677092\sources\install.wim"
